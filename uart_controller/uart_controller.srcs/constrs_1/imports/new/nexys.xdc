...
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { heartbeat }]; #IO_L10P_T1_D14_14 Sch=led16_g
...
##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btn4 }];
...
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { spi_csn }]; #IO_L12P_T1_MRCC_15 Sch=acl_csn
